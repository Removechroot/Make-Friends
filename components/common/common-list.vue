<template>
	...
	<view class="p-2">
		...
		<view class="flex bottom">
			...
			<view class="flex align-center justify-center flex-1 animate__animated animate__faster" @click="openDtail" hover-class="animate__animated animate__jello animate__fast">
